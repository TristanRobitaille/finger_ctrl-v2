...
static VALUE rb_stmpts3d (VALUE self, VALUE arr1, VALUE arr2, VALUE arr3,
                        VALUE i1, VALUE i2, VALUE i3, 
                        VALUE arr4, VALUE arr5, VALUE arr6, VALUE x1,
                        VALUE x2, VALUE x3, VALUE arr7, VALUE arr8, 
                        VALUE arr9, VALUE i4)
{ int nx, ny, nz, n, nmax;
  ...
  p7 = dbl_array (arr7, nmax);
  p8 = dbl_array (arr8, nmax);
  p9 = dbl_array (arr9, nmax);

  if (p1 != NULL && p2 != NULL && p3 != NULL && 
      p4 != NULL && p5 != NULL && p6 != NULL &&
      p7 != NULL && p8 != NULL && p9 != NULL) 
  { stmpts3d (p1, p2, p3, nx, ny, nz, p4, p5, p6, NUM2DBL (x1), NUM2DBL (x2),
              NUM2DBL (x3), p7, p8, p9, nmax, &n);
    copy_dblarray (p7, arr7, n);
    copy_dblarray (p8, arr8, n);
    copy_dblarray (p9, arr9, n);
  }
...
{ char *p;
  p = StringValuePtr (s1);
  writfl (NUM2INT (i1), (unsigned char *) p, NUM2INT (i2));
  return Qnil;
}
...
{ rb_Dislin = rb_define_module ("Dislin");
  ...
  rb_define_module_function (rb_Dislin, "stmpts3d", rb_stmpts3d, 16);
