...
#define		DELAY_MOVE		2e6

#define		MOVE_JACO_FORWARD		jojo_jaco.axis.trans_fb = -MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_fb = 0.0
									
#define		MOVE_JACO_BACKWARD		jojo_jaco.axis.trans_fb = MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_fb = 0.0
									
#define		MOVE_JACO_RIGHT			jojo_jaco.axis.trans_lr = -MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_lr = 0.0
									
#define		MOVE_JACO_LEFT			jojo_jaco.axis.trans_lr = MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_lr = 0.0

#define		MOVE_JACO_UP			jojo_jaco.axis.trans_rot = MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_rot = 0.0
									
#define		MOVE_JACO_DOWN			jojo_jaco.axis.trans_rot = -MAX_SPEED;\
									arm_test->move_joystick_axis(jojo_jaco.axis);\
									usleep(DELAY_MOVE);\
									arm_test->release_joystick();\
									jojo_jaco.axis.trans_rot = 0.0
